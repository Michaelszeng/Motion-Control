...
@TeleOp(name = "TurretTestV2")
public class TurretTestV2 extends LinearOpMode {
    String TAG = "TurretTestV2";
    ...
    DcMotor frontRight, backRight, frontLeft, backLeft, turret;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initHardwareMap(frontRight, backRight, frontLeft, backLeft, turret);
        ...
        while (opModeIsActive()) {   //put teleop code in here
            ...
            turret.setPower(turretController.update(turretPosition, (int) dateDiff, testTarget));
    ...
    private void initHardwareMap(DcMotor right_front, DcMotor right_back, DcMotor left_front, DcMotor left_back, DcMotor turret){
