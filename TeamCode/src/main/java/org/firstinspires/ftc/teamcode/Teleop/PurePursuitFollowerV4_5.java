...
public class PurePursuitFollowerV4_5 extends LinearOpMode {
    String TAG = "PurePursuitFollowerV4_5";
    ...
    File logFileErrors = AppUtil.getInstance().getSettingsFile("errorHistory_V4_5.txt");

    File logFile = AppUtil.getInstance().getSettingsFile("telemetry4_5.txt");
    String MPString;
