...
public class DriveConstants {
    ...
    /*
    //Attempted Zeigler Nichols Tuning
    public static double Ku = 1.0;
    public static double Tu = 1.0;      //Period of Sustained Oscillation (Sec) using Ziegler-Nichols Tuning

    public static double xPM = 0.6;
...
//    public static double xDM = 0.02043;     //Classic ZN
    ...
    public static double xDM = 0.067*Ku*Tu;        //No Overshoot ZN

    public static double yPM = 0.6;
...
//    public static double yDM = 0.02043;     //Classic ZN
    ...
    public static double yDM = 0.067*Ku*Tu;        //No Overshoot ZN

    public static double hPM = 0.6;      //No Overshoot ZN
...
//    public static double maxV = 62.308;  //Used to generate motion profile      Calculated using 87.5% of the theoretical max (https://www.learnroadrunner.com/drive-constants.html#base-constraints)
    public static double maxV = 32;  //Used to generate motion profile
//    public static double maxA = 70;      //Used to generate motion profile      Currently an Estimation
    ...
    public static double maxJ = 300;     //Used to generate motion profile      Currently an Arbitrary Value
